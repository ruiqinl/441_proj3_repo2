...
OBJS_proxy = proxy.o http_parser.o http_replyer.o helper.o mydns.o dns_lib.o list.o
OBJS_nameserver = http_parser.o http_replyer.o helper.o mydns.o dns_lib.o nameserver.o list.o
